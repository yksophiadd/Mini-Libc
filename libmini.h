...
#define SIG_ERR       3		 /* return value from signal() in case of error*/
#define SIG_DFL	      4		 /* request For the default signal handing*/
#define SIG_IGN       5		 /* To ignore this signal*/
